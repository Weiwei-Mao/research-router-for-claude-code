...
python main.py compare [模型1] [模型2] "[问题]"
```
...
python main.py compare "[代码相关的问题]"
```
...
python main.py compare gemini qwen "LSTM 和 GRU 在水文时序预测中哪个更合适？为什么？" --task lstm-vs-gru
```
